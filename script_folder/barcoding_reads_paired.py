'''
    ...
    then it attach the barcodes and UMI sequence to the read name of the read1 and read3 file (corresponding to Read 1 and Read 2).
'''   
    ...
    while (R1_in1):
        ...
        if target_lig in ligation_barcode_list:
            ...
            if target_RT in RT_barcode_list:
                ...
                R1_out1 = '@' + lig_barcode + RT_barcode + ',' + UMI + ',' + R1_in1[1:]
...
def attach_UMI_files(input_folder, sampleID, output_folder, ligation_barcode_file, RT_barcode_file, core, randomN_barcode_file):
    ...
    RT barcode file: %s
    randomN_barcode_file: %s
    
    ___________________________________________________________________________
    ''' %(input_folder, sampleID, output_folder, ligation_barcode_file, RT_barcode_file, randomN_barcode_file)
    ...
    barcodes = open(randomN_barcode_file, "rt")
    randomN_barcodes = []
